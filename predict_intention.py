            ...
            if send_flag == 0 and show:
                ...
                if qBlazepose.has():
                    ...
                    if body:
                        ...
                        if righthand[0] < -0.4:
                            cv2.putText(masked_frame, "want tubes", (2, frame.shape[0] - 52), cv2.FONT_HERSHEY_TRIPLEX, 0.4, (255,255,255))
                        elif abs(rightelbow[2] - rightshoulder[2]) < 0.01 and righthand[0]<-0.3:
                            cv2.putText(masked_frame, "pick connectors", (2, frame.shape[0] - 68), cv2.FONT_HERSHEY_TRIPLEX, 0.4, (255,255,255))
                        traj.append(body)
